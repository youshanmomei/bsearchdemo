...
public abstract class MailMultipleOutputFormat<K extends WritableComparable<?>, V extends Writable> extends FileOutputFormat<K, V> {
	...
	public class MultiRecordWriter extends RecordWriter<K, V>{
		...
		private RecordWriter<K, V> getBaseRecordWriter(TaskAttemptContext job, String baseName) throws IOException{
			...
			if (isCompressed) {
				...
				recordWriter = new MailRecordWriter<K, V>(new DataOutputStream(codec.createOutputStream(fileOut)), keyValueSeparator);
